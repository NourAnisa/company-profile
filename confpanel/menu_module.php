 ...
 <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="../../template.php" class="logo"><b>PT Telkom | Admin Panel</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="#"><img src="../img/bumper_telkom_indonesia.png" class="img-circle" width="60"></a></p>
